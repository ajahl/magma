...
func Test_Tiers(t *testing.T) {
	...
	tc = tests.Test{
		...
		Handler:        createTier,
		ExpectedStatus: 500,
		ExpectedError:  "could not find entities matching" + tests.Separator + "[type:\"magmad_gateway\"" + tests.Separator + "key:\"g1\"]",
	}
	tests.RunUnitTest(t, e, tc)
...
func TestPartialTierUpdates(t *testing.T) {
	...
	tc = tests.Test{
		...
		ParamValues:    []string{"n1", "tier1"},
		ExpectedStatus: 500,
		ExpectedError:  "could not find entities matching" + tests.Separator + "[type:\"magmad_gateway\"" + tests.Separator + "key:\"g4\"]",
	}
	tests.RunUnitTest(t, e, tc)
